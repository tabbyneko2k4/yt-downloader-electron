            ...
            {downloaderStage === 'stage1' ? (
              ...
              <div className="flex flex-col items-center justify-center py-4 px-2 space-y-3 animate-fade-in-up transform-gpu">
                <div className="text-center space-y-1">
                  <div className="inline-flex p-2 rounded-2xl bg-pink-500/10 border border-pink-500/20 mb-0.5 shadow-md shadow-pink-500/10">
                  ...
                  <div className="w-full p-2.5 rounded-xl bg-gradient-to-r from-purple-500/15 via-pink-500/15 to-sky-500/15 border border-pink-500/30 backdrop-blur-md space-y-1.5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 text-xs font-bold text-pink-600 dark:text-pink-400 truncate">
                        <Globe size={13} className="animate-spin-slow shrink-0" />
                        <span className="truncate">{activeTabInfo.title || 'Active Tab Detected'}</span>
                      </div>
                    </div>
                    <button
                      onClick={handleDownloadActiveTab}
                      disabled={isAnalyzing}
                      className="w-full py-1.5 px-3 rounded-lg bg-gradient-to-r from-pink-500 via-purple-500 to-sky-500 hover:opacity-95 active:scale-98 text-white text-xs font-bold shadow-md shadow-pink-500/20 flex items-center justify-center gap-1.5 cursor-pointer transition-all duration-200"
                    >
                      <Zap size={14} className="animate-bounce" />
                      <span>⚡ Tải Tab Hiện Tại Ngay</span>
                    </button>
                  </div>
                )}
              ...
              <div className="flex flex-col gap-2.5 animate-fade-in-up transform-gpu">
                ...
                <div className="flex items-center justify-between pb-0.5">
                  <button
                    className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 active:scale-95 text-slate-700 dark:text-slate-300 text-xs font-medium border border-slate-200 dark:border-white/10 transition-all duration-200 cursor-pointer"
                ...
                {mediaInfo && mediaInfo.info && (
                  <div className="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-xl shadow-md space-y-2 transform-gpu">
                ...
                {mediaInfo && mediaInfo.isPlaylist && mediaInfo.info && mediaInfo.info.entries && (
                  <div className="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-xl space-y-2.5 shadow-md">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="max-h-36 overflow-y-auto space-y-1 bg-slate-50 dark:bg-slate-950/60 p-1.5 rounded-xl border border-slate-200 dark:border-slate-800">
                ...
                <div className="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/80 border border-slate-200/80 dark:border-slate-800/80 backdrop-blur-xl space-y-2 shadow-md">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1.5 text-xs font-bold text-slate-800 dark:text-slate-100">
